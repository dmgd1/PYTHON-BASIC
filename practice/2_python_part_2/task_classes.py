...
class Student:
    ...
    def do_homework(self, assigned_homework):
        return "Homework done" if assigned_homework.is_active() else "You are late"
...
class Homework:
    ...
    def is_active(self):
        deadline = self.created + self.deadline
        return True if self.created < deadline else False
